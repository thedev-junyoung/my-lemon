...
ALTER USER 'lemon'@'%' IDENTIFIED WITH caching_sha2_password BY '081908';

-- 'root' 사용자의 인증 플러그인을 'caching_sha2_password'로 설정
ALTER USER 'root'@'%' IDENTIFIED WITH caching_sha2_password BY '081908';
